...
make_conf()
{
	...
	aconf = (ConfItem *)rb_bh_alloc(confitem_heap);
 ...
 */
static void
expire_temp_kd(void *list_)
{
	rb_dlink_node *ptr;
	rb_dlink_node *next_ptr;
	struct ConfItem *aconf;

	rb_dlink_list *list = (rb_dlink_list *)list_;
