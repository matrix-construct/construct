...
static const yytype_uint16 yyrline[] =
{
     ...
     202,   213,   214,   217,   225,   226,   229,   233,   253,   259,
     265,   271,   294,   293,   307,   308,   309,   311,   323,   327
};
#endif
...
#line 218 "ircd_parser.y"
    {
			conf_call_set(conf_cur_block, (yyvsp[(1) - (4)].string), cur_list);
...
#line 234 "ircd_parser.y"
    {
		...
		if ((yyvsp[(1) - (3)].conf_parm)->type != CF_INT || (yyvsp[(3) - (3)].conf_parm)->type != CF_INT)
		{
